 ...
 */
export interface AndroidSafetyNetAttestation extends ParsedAttestationObject {
...
export const isAndroidSafetyNetAttestation = (obj: {
	[key: string]: any;
}): boolean => {
	if (
		obj['fmt'] &&
...
// export function AndroidSafetyNetVerify(
...
// 	const decryptCert: x5cInterface = Certificate.fromPEM(
// 		Buffer.from(cert)
// 	) as any;
